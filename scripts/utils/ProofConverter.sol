...
library ProofConverter {
     ...
     * @dev - In case of that there are 1 public inputs (bytes32 * 1 = 32 bytes), the proof file includes 32 bytes of the public inputs at the beginning. Hence it should be removed by using this function.
     */
    function sliceAfter32Bytes(bytes memory data) internal pure returns (bytes memory) {
